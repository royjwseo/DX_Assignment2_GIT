...
#define PARAMETER_MATERIAL_CONSTANTS	2
#define PARAMETER_LIGHT_CONSTANTS	2
#define PARAMETER_TIME_CONSTANTS	3
#define PARAMETER_STANDARD_TEXTURE		4
#define PARAMETER_CUBE_TEXTURE	5
...
namespace Vector3
{
	...
	inline XMFLOAT3 Subtract(XMFLOAT3& xmf3Vector1, XMFLOAT3& xmf3Vector2, bool bNormalize)
	{
		XMFLOAT3 xmf3Result;
		if (bNormalize)
